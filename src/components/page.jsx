  ...
  <section class="text-gray-400 body-font bg-gray-900">
    <div class="container px-5 py-24 mx-auto">
      ...
      <div class="flex flex-wrap -m-4 justify-center">
        <div class="xl:w-1/4 md:w-1/2 p-4 flex items-stretch">
          <div class="bg-gray-800 bg-opacity-40 p-6 rounded-lg w-full flex flex-col justify-between">
            <div>
              ...
              <p class="leading-relaxed text-base">Built a React FreeCodeCamp style platform with a LeetCode 'Two Sum' focus. Integrated CodeMirror for an enhanced code editing experience, used Judge0 API for code compilation. Implemented CI/CD pipeline with Docker and GitHub Actions, deploying to AWS Elastic Beanstalk for optimal scalability.</p>
            </div>
            <div class="flex justify-between py-5">
              <button class="text-white hover:bg-green-600 bg-green-500 rounded p-3"><Link to='/freeleetcodecamp'>Learn more...</Link></button>
              <button class="text-white hover:bg-green-600 bg-green-500 rounded p-3"><a href='https://github.com/KianIsNotAvailable/freeleetcodecamp' target='_blank'>View on Github</a></button>
            </div>
          </div>
        </div>
        <div class="xl:w-1/4 md:w-1/2 p-4 flex items-stretch">
          <div class="bg-gray-800 bg-opacity-40 p-6 rounded-lg w-full flex flex-col justify-between">
            <div>
              <img class="h-40 rounded w-full object-center object-contain mb-6" src={Korean} alt="content"/>
            ...
            <div class="flex justify-between py-5">
              <button class="text-white hover:bg-green-600 bg-green-500 rounded p-3"><Link to='/korean-quiz'>Learn more...</Link></button>
              <button class="text-white hover:bg-green-600 bg-green-500 rounded p-3"><a href='https://github.com/KianIsNotAvailable/learn-korean' target='_blank'>View on Github</a></button>
            </div>
          </div>
        </div>
        <div class="xl:w-1/4 md:w-1/2 p-4 flex items-stretch">
          <div class="bg-gray-800 bg-opacity-40 p-6 rounded-lg w-full flex flex-col justify-between">
            <div>
              <img class="h-40 rounded w-full object-center object-contain mb-6" src={Chatbot} alt="content"/>
            ...
            <div class="flex justify-between py-5">
              <button class="text-white hover:bg-green-600 bg-green-500 rounded p-3 w-full md:w-auto"><Link to='/twitch-bot'>Learn more...</Link></button>
              <button class="text-white hover:bg-green-600 bg-green-500 rounded p-3 w-full md:w-auto"><a href='https://github.com/KianIsNotAvailable/twitch-bot' target='_blank'>View on Github</a></button>
            </div>
          </div>
        </div>
      </div>
